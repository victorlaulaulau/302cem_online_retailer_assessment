    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Monitor</h2>
                    <!-- Loop here -->
                    <?php include('includes/front/mon-items.php');?>
                </div><!--features_items-->
				
                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Computer</h2>
                    <!-- Loop here -->
                    <?php include('includes/front/computer-items.php');?>
                </div><!--features_items-->

                <div class="features_items"><!--features_items-->
                    <h2 class="title text-center">Display Card</h2>
                    <!-- Loop here -->
