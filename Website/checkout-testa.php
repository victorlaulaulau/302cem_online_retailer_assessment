	...
	<section id="cart_items">
		<div class="container">
                ...
                <tr>
                  ...
                  <td colspan="2">
                    <table class="table table-condensed total-result">
                        ...
                        <tr>
                          <td>Delivery Cost</td>
                          <td><span id="payment-total">$ <?php if(isset($_GET['destination'])){ echo $user->destinationAmount($_GET['destination']);}else {
                            echo "0";
                          } ?></span></td>
                        </tr>
                        ...
                        <tr>
                          <td>Total</td>
                          <td><span id="payment-total">$ <?php if(isset($_GET['destination'])){echo $payment_total+$user->destinationAmount($_GET['destination']);}else {
                            echo $payment_total;
                          } ?></span></td>
                        </tr>
                        <tr>
			...
			<div class="payment-options">
					...
					<span>
						<label><input type="radio"> Check Payment</label>
					</span>
					<span>
